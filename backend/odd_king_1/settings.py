"""
Django settings for odd_king_1 project.
...
WSGI_APPLICATION = 'odd_king_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_king_1 API",
    "DESCRIPTION": "API documentation for odd_king_1 App",
    "VERSION": "v1",
}
